        ...
        <div className="home-video-blc d-flex justify-items-center align-items-center">
          <div>
            ...
            <p className="text-white">
              Our objective is to provide a platform  where service providers and service seeker
              can come interact and exchange services on the bases of requirements.
          </p>
            <div className="home-video-inner d-flex justify-items-center align-items-center position-relative">
              ...
              <video width="400" controls>
                <source src={require('../../../src/assets/sample.mp4')} type="video/mp4" />
