...
const JobProduct = ({ product, listType, path }) => {
  ...
  return (
    <div className={"job-wrapper d-flex flex-column flex-fill " + (listType ? "d-flex flex-column" : "")}>
      ...
      <div
        className={
          "job-inner d-flex flex-column flex-fill " + (listType ? "d-flex flex-column flex-fill" : "")
        }
      >
        <div
          className={
