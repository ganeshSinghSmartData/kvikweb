              ...
              <LocalForm onSubmit={values => _handleSubmit(values)}>
                {path ? (
                  <JobAddress job_seeker_id={user} />
                    ...
                    <>
                      <div className={`job-address peace d-flex ${!path ? 'editMode' : ''}`}>
                        <UserImage />
                        <div className="job-user-info flex-fill">
                          ...
                          <div className="edit-profile-btns">
                            ...
                            <Button color="link" className="btn-dark cancel" type="button">
                              Cancel
                           </Button>
                          </div>
                        </div>
          ...
          <div className="user-cards-rw">
            <div className="user-cards">
              <span className="d-block">
                <svg xmlns="http://www.w3.org/2000/svg" width="59.434" height="39.623" viewBox="0 0 59.434 39.623">
                  <defs>
