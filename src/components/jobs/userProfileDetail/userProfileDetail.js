          ...
          <div className="user-profl-rw d-flex">
            ...
            <div className="user-profl-edit flex-shrink-0">
              <Button color="link" className="edit-btn">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="19.446" height="19.435" viewBox="0 0 19.446 19.435">
                    <path id="edit" d="M18.987,1.513a4.29,4.29,0,0,0-6.07,0L1.788,12.633a.556.556,0,0,0-.157.319l-.825,6.1a.555.555,0,0,0,.157.468.566.566,0,0,0,.394.166.452.452,0,0,0,.075,0l3.679-.5a.56.56,0,1,0-.149-1.11l-2.95.4.576-4.258L7.071,18.7a.566.566,0,0,0,.394.166.549.549,0,0,0,.394-.166L18.987,7.58a4.283,4.283,0,0,0,0-6.067ZM13.132,2.88,15,4.748,4.846,14.9,2.977,13.031ZM7.468,17.516,5.641,15.69,15.8,5.539l1.827,1.826ZM18.4,6.566,13.932,2.1A3.175,3.175,0,0,1,18.4,6.566Z" transform="translate(-0.8 -0.255)" fill="#9d9d9d" />
                  </svg>
                </span>
          ...
          <div className="user-cards-rw">
            <div className="card-chip">
              <div className="card-chip-hd text-right">
                <svg xmlns="http://www.w3.org/2000/svg" width="44.679" height="25" viewBox="0 0 44.679 25">
              ...
              <div className="card-chip-no">
                <span>1234</span>
                <span>5678</span>
                <span>125<span className="grey-digit">X</span></span>
          ...
          <div className="user-cards-rw">
            <div className="user-cards">
              <span className="d-block">
                <svg id="credit-card" xmlns="http://www.w3.org/2000/svg" width="59.434" height="39.623" viewBox="0 0 59.434 39.623">
                  <defs>
